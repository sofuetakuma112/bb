...
function UserItem({
  ...
  return (
    <div className={clsx('flex w-full justify-between gap-y-2 overflow-hidden', className)}>
      <div className="flex">
        ...
        <Link href={`/${userId}/home`} className="flex items-center">
          <p className="text-black-black pb-3 text-lg font-semibold">{userName}</p>
        </Link>
      </div>
